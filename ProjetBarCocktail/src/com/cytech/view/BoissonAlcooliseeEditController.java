...
public class BoissonAlcooliseeEditController {
	...
	private BoissonAlcoolisee boisson;
	...
	public void setBoissonAlcoolisee(BoissonAlcoolisee boisson) {
    ...
    private void handleOk() {
        if (isInputValid()) {
            ...
            for (BoissonAlcoolisee b: mainApp.getBoissonAlcoolisee()) {
            	if (b.getNom().equals(nom.getText())) {
            		mainApp.getBoissonAlcoolisee().set(mainApp.getBoissonAlcoolisee().indexOf(b), boisson);
            		modifie = true;
            		GestionBoissonAlcoolisee.ecritureToutStock(mainApp.getBoissonAlcoolisee());
            		break;
            	}
            }
            if (!modifie) {
            	GestionBoissonAlcoolisee.ecritureBoissonAlcoolisee(boisson);
            }
